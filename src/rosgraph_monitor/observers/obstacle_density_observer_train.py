...
class ObstacleDensityObserverTrain(TopicObserver):
    def __init__(self, name):
        ...
        # self._pub_metric4 = rospy.Publisher('/metrics/obstacle_density14', Float64, queue_size=10)
        self._pub_metric1 = rospy.Publisher('/metrics/obstacle_density21', Float64, queue_size=10)
        # self._pub_metric6 = rospy.Publisher('/metrics/obstacle_density22', Float64, queue_size=10)
    ...
    def calculate_attr(self, msgs):
        ...
        length = len(self._ODw_i[yaw])
        for n in self._ODw_i[yaw]:
            # print(n)
